...
describe('MySetsService', () => {
	...
	test('removeImageSet should send http delete request', () => {
		...
		http.expectOne({
			method: 'DELETE',
			url: AppSettings.apiUrl + 'images/' + mockSet.imageId + '?setId=' + mockSet.id
		});
	});
	...
	test('isNextDisabled should return true if track is last', () => {
	...
	test('isNextDisabled should return true if false is not last', () => {
